...
export function CivicaXDashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#07193b] text-slate-100 font-sans select-none">
      {/* ------------------------------------------------------------- TOP HEADER BAR */}
      <header className="bg-[#041026] border-b border-blue-900/60 text-white">
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setCurrentView('dashboard')}>
            ...
            <div>
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-bold tracking-tight text-white">CivicaX</span>
                <span className="hidden md:inline-block text-[10px] tracking-wider uppercase font-semibold text-sky-400 bg-blue-950/80 px-2 py-0.5 rounded border border-blue-800/60">
                  BLOCKCHAIN INFRASTRUCTURE MONITORING SYSTEM
                </span>
              </div>
              <span className="md:hidden text-[9px] tracking-wider uppercase font-medium text-sky-300">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2.5 bg-blue-950/60 px-3 py-1.5 rounded-lg border border-blue-800/40">
              <PhilippineFlag className="w-5 h-3.5 rounded-sm shadow-sm" />
              <span className="text-xs font-medium text-slate-200">City Oversight dept.</span>
            </div>

            <button
              onClick={() => setCurrentView(currentView === 'dashboard' ? 'detail' : 'dashboard')}
              className="flex items-center gap-1.5 text-xs font-medium text-slate-300 hover:text-white px-2 py-1 rounded bg-blue-900/40 hover:bg-blue-900/70 border border-blue-700/50 transition-colors"
            >
              <span>Admin</span>
        ...
        {/* Navigation Tabs Bar */}
        <div className="flex items-center gap-8 px-6 pt-1 text-sm font-medium border-t border-blue-900/40 bg-[#030d20]">
          <button
            onClick={() => {
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* LEFT NAV SIDEBAR */}
        <aside className="w-56 bg-[#030d20] border-r border-blue-950/80 flex flex-col shrink-0 py-6 px-3">
        ...
        {/* MAIN DISPLAY AREA */}
        <main className="flex-1 bg-[#d8e6f7] overflow-y-auto p-5 text-slate-900">
          <div className="max-w-7xl mx-auto space-y-4">
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
              ...
              <div
                ...
                className={`cursor-pointer rounded-xl p-4 transition-all duration-200 shadow-sm border ${
                  currentView === 'detail'
              ...
              >
                <div className="text-xs font-bold uppercase tracking-wider opacity-85">Active Projects</div>
                <div className="mt-1.5 text-3xl font-extrabold tracking-tight text-center sm:text-left">18</div>
              </div>

              {/* Card 2: Pending Approvals */}
              <div
                onClick={() => setCurrentView('detail')}
                className="cursor-pointer bg-white rounded-xl p-4 shadow-sm border border-slate-200/80 hover:border-blue-400 transition-all"
              >
                <div className="text-xs font-bold uppercase tracking-wider text-slate-700 opacity-85">Pending Approvals</div>
                <div className="mt-1.5 text-3xl font-extrabold tracking-tight text-slate-900 text-center sm:text-left">5</div>
              </div>

              {/* Card 3: Completed Milestones */}
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200/80">
                <div className="text-xs font-bold uppercase tracking-wider text-slate-700 opacity-85">Completed Milestones</div>
                <div className="mt-1.5 text-3xl font-extrabold tracking-tight text-slate-900 text-center sm:text-left">42</div>
              </div>
              ...
              <div
                ...
                className="cursor-pointer bg-white rounded-xl p-4 shadow-sm border border-slate-200/80 hover:border-blue-400 transition-all"
              >
                <div className="text-xs font-bold uppercase tracking-wider text-slate-700 opacity-85">Validating Nodes</div>
                <div className="mt-1.5 text-3xl font-extrabold tracking-tight text-slate-900 text-center sm:text-left">7/9</div>
              </div>
            </section>
                ...
                <div className="lg:col-span-6 space-y-4">
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200/80">
                    ...
                    <div className="mt-3 space-y-2.5">
                      ...
                      >
                        ...
                        <span className="px-3 py-1 rounded-full text-[11px] font-semibold bg-[#1b7339] text-white shadow-xs">
                          In Progress
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between p-2.5 rounded-lg hover:bg-slate-50 transition-colors">
                        ...
                        <span className="px-3 py-1 rounded-full text-[11px] font-semibold bg-[#b32626] text-white shadow-xs">
                          Pending Approval
                        </span>
                      </div>
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200/80">
                    ...
                    <div className="mt-3 space-y-3 text-xs">
                      ...
                      <div className="flex items-start justify-between gap-2 pb-2 border-b border-slate-100">
                        ...
                        <span className="font-mono text-[11px] text-slate-500 font-semibold">[Blk# - 2541]</span>
                      ...
                      <div className="flex items-start justify-between gap-2 pb-2 border-b border-slate-100">
                        ...
                        <span className="font-mono text-[11px] text-slate-500 font-semibold">[Blk# - 3541]</span>
                        <div className="text-right text-[11px] text-slate-500">
                          <div>Today</div>
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span className="font-mono text-[11px] text-slate-500 font-semibold">[Blk# - 1252]</span>
                        <div className="text-right text-[11px] text-slate-500">
                          <div>Yesterday</div>
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200/80">
                    ...
                    <div className="flex items-center justify-center py-2">
                      ...
                      {/* Legend */}
                      <div className="ml-6 space-y-1.5 text-[11px]">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="w-3 h-3 rounded-xs bg-[#1e3a8a]" />
                ...
                <div className="lg:col-span-6 space-y-4">
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200/80">
                    ...
                    <div className="mt-3 relative h-36 w-full">
                      ...
                      <div className="flex items-center justify-between text-[11px] font-bold text-slate-700 pt-2 border-t border-slate-100 px-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                    ...
                    <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200/80 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="space-y-1.5 text-xs text-slate-700">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="font-mono text-[10px] text-slate-800">2026 - 01 - 02 : 10:42 AM</span>
                          </div>
                        ...
                        <div className="mt-3 pt-2 border-t border-slate-100">
                          ...
                          <div className="space-y-1 text-[11px] text-slate-700">
                            <div className="flex items-center gap-1.5">
                              <span className="w-3.5 h-3.5 bg-emerald-600 text-white rounded-xs flex items-center justify-center text-[9px]">✓</span>
                      ...
                      <div className="mt-4 text-right">
                        <button
                          onClick={() => setShowLedgerModal(true)}
                          className="px-3.5 py-1.5 bg-[#072459] hover:bg-[#051a40] text-white text-xs font-semibold rounded-lg shadow-xs transition-colors"
                        >
                          View Ledger
                        </button>
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#0c3975] hover:underline bg-white/70 hover:bg-white px-3 py-1.5 rounded-lg border border-slate-200 transition-colors shadow-xs"
                  >
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200/80 space-y-6">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Bridge Rehabilitation</h2>
                      <div className="text-base font-bold text-[#0c3975] mt-0.5">Project ID: CRN - 1467-01</div>
                    </div>
                    <button className="text-slate-400 hover:text-slate-600">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    {/* Left: 65% Complete */}
                    <div className="md:col-span-5 bg-slate-50/80 rounded-xl p-6 flex flex-col items-center justify-center border border-slate-200/60 shadow-inner">
                      <div className="text-6xl font-black text-[#0c3975] tracking-tight">65 %</div>
                      <div className="text-sm font-bold text-slate-600 mt-1 uppercase tracking-wide">Complete</div>
                    ...
                    <div className="md:col-span-7 bg-[#f5c037] text-slate-950 rounded-xl p-6 flex flex-col justify-between shadow-sm border border-amber-400">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                          <div className="text-xs font-bold uppercase tracking-wider text-slate-800">Funds Disbursed</div>
                          <div className="text-2xl font-black tracking-tight mt-0.5">PHP 15,239,000.00</div>
                        </div>

                        <div>
                          <div className="text-xs font-bold uppercase tracking-wider text-slate-800">Next Milestone</div>
                          <div className="text-lg font-black tracking-tight mt-0.5 uppercase">INSPECTION PHASE</div>
                        </div>
                      </div>

                      <div className="mt-4 pt-3 border-t border-amber-600/30 flex items-center justify-between text-xs font-medium">
                        <span>Disbursed via Smart Contract Ledger</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 pt-2">
                    ...
                    <div className="md:col-span-5 bg-white rounded-xl overflow-hidden border border-slate-200 flex flex-col">
                      ...
                      <div className="p-4 space-y-4 text-xs font-medium text-slate-800 flex-1">
      ...
      {showLedgerModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-3xl max-h-[85vh] flex flex-col shadow-2xl overflow-hidden text-slate-900">
            {/* Header */}
            <div className="bg-[#041026] text-white px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <Database className="w-5 h-5 text-sky-400" />
                <div>
                  <h3 className="text-base font-bold">CivicaX Immutable Blockchain Ledger</h3>
                  <div className="text-[11px] text-slate-400 font-mono">Cryptographic Hash Chain • Consensus Height 1642</div>
                </div>
              </div>
              <button
            ...
            {/* Filter Pills */}
            <div className="px-6 py-3 border-b border-slate-100 bg-slate-50 flex items-center gap-2 text-xs">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-3 text-xs">
              {ledgerBlocks
                ...
                .map((blk) => (
                  <div key={blk.id} className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 hover:bg-blue-50/40 transition-colors">
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-2 text-[11px] font-mono text-slate-600 bg-white p-2.5 rounded border border-slate-200/80">
                      <div>
            ...
            <div className="px-6 py-3 border-t border-slate-200 bg-slate-50 flex items-center justify-between text-xs text-slate-500">
              <span>All blocks verified by PBFT consensus protocol</span>
              <button
                onClick={() => setShowLedgerModal(false)}
                className="px-4 py-1.5 bg-[#0c3975] hover:bg-[#072459] text-white font-semibold rounded-lg transition-colors"
              >
                Close
              </button>
            </div>
